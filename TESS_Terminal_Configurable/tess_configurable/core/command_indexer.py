...
logger = logging.getLogger("CommandIndexer")
...
class CommandIndexer:
    ...
    def _scan_commands_powershell(self):
        ...
        # Configurable structure: module is in tess_configurable/core/, scripts in tess_configurable/scripts/
        # Get path relative to this file
        current_dir = os.path.dirname(os.path.abspath(__file__)) # core
        root_dir = os.path.dirname(current_dir) # tess_configurable
        script_path = os.path.join(root_dir, "scripts", "scan_commands.ps1")
